        ...
        <section className="section reveal-on-scroll">
          <div className="container contact-layout">
            ...
            <div className="contact-side-stack">
              ...
              <article className="contact-detail-list premium-panel">
                <div>
                  <MapPin size={18} />
                  <div>
                    <h3>Service Area</h3>
                ...
                <div>
                  ...
                  <div>
                    ...
                    <p>Share how you prefer to be reached and the follow-up can stay simple.</p>
                  </div>
                </div>
              </article>
              ...
              <article className="premium-panel faq-panel">
                ...
                <h3>Keep the inquiry focused and easy to answer.</h3>
